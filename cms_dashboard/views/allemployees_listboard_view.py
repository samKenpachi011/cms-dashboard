...
class AllEmployeesListBoardView(NavbarViewMixin, EdcBaseViewMixin,
                    ListboardFilterViewMixin, SearchFormViewMixin, ListboardView):

    listboard_template = 'allemployees_listboard_template'
    listboard_url = 'allemployees_listboard_url'
    ...
    ordering = '-modified'
    paginate_by = 10
    search_form_url = 'allemployees_listboard_url'
